...
public final class NormalRequestSituation implements Situation {

    @Override
    public @NotNull String getName() {
        return "Normal REQUEST flow (no errors expected)";
    }
    ...
    public boolean execute() {
        ...
        try {
            ...
            Main.log.trace("Creating a bidirectional stream for a normal REQUEST");
            ...
            Main.log.info("Sending normal REQUEST on bidirectional stream");
            ...
            if (!allowed) {
                ...
                Main.log.severe("Server did not accept a structurally valid REQUEST.");
                return false;
            }
            ...
            try {
                ...
                Main.log.severe("Received FAIL after a supposedly valid REQUEST: " + fail);
                ...
                if (failTarget == streamId) {
                    ...
                    Main.log.severe("FAIL targets another stream (" + failTarget + ") after a valid REQUEST.");
                }
