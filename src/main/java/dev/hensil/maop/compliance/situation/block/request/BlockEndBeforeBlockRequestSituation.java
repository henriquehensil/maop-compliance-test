...
@Plugin
@Category("Situation")
final class BlockEndBeforeBlockRequestSituation extends Situation {

    // Static initializers

    private static final @NotNull Logger log = Logger.create(BlockEndBeforeBlockRequestSituation.class);
    ...
    public boolean diagnostic() {
        ...
        try {
            ...
            @NotNull Operation operation = connection.await(stream, 1000, TimeUnit.SECONDS);
